...
ifndef UNITY_OBJS_DIR
    UNITY_OBJS_DIR = ./build/objs/dummy_folder/dummy_folder
endif

# Default dir for the outout library
ifndef UNITY_LIB_DIR
    UNITY_LIB_DIR = ./build/lib
endif
...
TARGET_LIB = \
    $(UNITY_LIB_DIR)/lib_$(COMPONENT_NAME).a
    
TEST_TARGET = \
    ./build/$(COMPONENT_NAME)_tests
